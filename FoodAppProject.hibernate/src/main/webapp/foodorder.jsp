<%@page import="FoodApp_pro.dto.User"%>
...
<%
	...
	<a href="swiggyfoodorder"><button>+ADD</button></a>
	...
	<form action="print">
		<table>
			...
			<tr>
				<td>Phone :</td>
				<td><input type="tel" name="phno" value="<%=user.getPhno()%>"
					placeholder="Enter the customer phno"></td>
			</tr>
